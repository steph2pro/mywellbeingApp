...
import 'package:mywellbeing/screen/professionel.dart';

import 'package:mywellbeing/screen/profil.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
           ...
           ElevatedButton(
              ...
              child: Text('professionel de sante',style: TextStyle(color: Colors.white,fontSize: 25,fontWeight: FontWeight.bold),),
            style: ElevatedButton.styleFrom(
            backgroundColor: Colors.blueAccent.withOpacity(.7), // Couleur de fond du bouton
            fixedSize: Size(300, 50), // Définir la taille du bouton (hauteur, largeur)
            shape: RoundedRectangleBorder(
